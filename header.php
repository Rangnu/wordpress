...
<head>
    ...
    <!--Font Awesome-->
    <link rel="stylesheet" href="/wp-content/themes/oppahub/assets/css/solid.css">
    <link rel="stylesheet" href="/wp-content/themes/oppahub/assets/css/fontawesome.min.css">
    <link rel="stylesheet" href="/wp-content/themes/oppahub/assets/css/brands.min.css">
    <!--Google Font-->
    ...
    <meta name="google-site-verification" content="NLL4VfFoLgDOzdmaoG9kurabCUjcOb7ooycKdsb3AZM" />
    <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-2390907231823910"
    ...
    <header class="header-default" style="padding-bottom: 4px;">
            <nav class="navbar navbar-expand-lg">
                ...
                <div class="container-xl">
                    ...
                    <!-- logo  -->
                    <a href="https://oppahub.com" class="navbar-brand">
                        <div class="oppahub">
                    ...
                    <div class="header-buttons">
                        <button class="search icon-button" aria-label="search_button">
                            <i class="fa-solid fa-magnifying-glass"></i>
                        </button>
                        <button class="UsersProfiles icon-button" aria-label="sersProfile_button">
                        ...
                        <button class="burger-menu icon-button" aria-label="menu_button">
